...
void ShapeT::loadMesh(const string &meshName, string *mtlpath, unsigned char *(loadimage)(char const *, int *, int *, int *, int))
{
	// Load geometry
...
void ShapeT::draw(const shared_ptr<ProgramT> prog,bool use_extern_texures) const
{
	for (int i = 0; i < obj_count; i++)
